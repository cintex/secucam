...
uses
  SysUtils, ExtCtrls, Graphics, Math, Types;
...
type
  ...
  public
    ...
    procedure CheckDifference (var pCmpImg, pRefImg: TBitmap; var pDiff: integer);
  end;
...
implementation
  ...
  procedure TCamComparator.CheckDifference (var pCmpImg, pRefImg: TBitmap; var pDiff: integer);
  var X, Y: integer;
  begin
